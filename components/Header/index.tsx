...
const Header = ({ scrollTo }: Props) => {
    ...
    return (
        <header className="flex justify-between items-center py-4 px-10 bg-white dark:bg-black border-b-2 border-b-gray-300 transition duration-500" style={{ opacity: headerOpacity }}>
